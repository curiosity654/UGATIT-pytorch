...
class UGATIT(object) :
    ...
    def build_model(self):
        ...
        self.trainA = ImageFolder(os.path.join('/kaggle/input/', self.dataset, 'trainA'), train_transform)
        self.trainB = ImageFolder(os.path.join('/kaggle/input/', self.dataset, 'trainB'), train_transform)
        self.testA = ImageFolder(os.path.join('/kaggle/input/', self.dataset, 'testA'), test_transform)
        self.testB = ImageFolder(os.path.join('/kaggle/input/', self.dataset, 'testB'), test_transform)
